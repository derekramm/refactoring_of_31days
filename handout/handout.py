...
class Handout(object):
    ...
    def add_video(self, video, img_format='gif', fps=30, width=None, show=False):
        if isinstance(video, str):
            filename = video
        else:
            import imageio
            filename = 'video-{}.{}'.format(self._num_videos, img_format)
    ...
    def show(self):
        ...
        names = ['style.css', 'highlight.css', 'highlight.js', 'marked.js', 'script.js', 'favicon.ico']
        for name in names:
            shutil.copyfile(
